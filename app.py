...
def Loan_Amount_predict():
    ...
    if flask.request.method == 'POST':
        ...
        user_daysBirth=float(flask.request.form['user_age'])*-360               
        user_daysEmployed=float(flask.request.form['User_employment_days'])*-1
        list_of_inputs=[user_credit,user_downPayment,user_goodsPrice,user_annualIncome,user_daysBirth,user_daysEmployed]
        list_of_inputs = np.array(list_of_inputs).reshape(1,6)
